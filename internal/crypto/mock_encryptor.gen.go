...
func (_mock *MockEncryptor) Decrypt(ciphertext []byte) ([]byte, error) {
...
func (_c *MockEncryptor_Decrypt_Call) Run(run func(ciphertext []byte)) *MockEncryptor_Decrypt_Call {
...
func (_c *MockEncryptor_Decrypt_Call) Return(bytes []byte, err error) *MockEncryptor_Decrypt_Call {
	_c.Call.Return(bytes, err)
	return _c
}

func (_c *MockEncryptor_Decrypt_Call) RunAndReturn(run func(ciphertext []byte) ([]byte, error)) *MockEncryptor_Decrypt_Call {
	_c.Call.Return(run)
	return _c
}
